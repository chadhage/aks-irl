...
> 60 minutes. Open-book (the repo). Closed-collaboration. Each section is scored independently so a strong performance in one area can offset a weak one elsewhere.
...
Pick any **other** pod's ADR (Module 00) and write a 1-page review:
- One thing they got right and why it matters
- One thing you'd challenge and what alternative you'd propose
- One assumption they didn't surface

This question is the difference between "passed L300" and "earned L400". You can only earn L400 if you complete it **and** correctly answer at least one of C4 or D4.
...
```bash
mkdir -p assessment/submissions/$YOUR_NAME
$EDITOR assessment/submissions/$YOUR_NAME/answers.md
git add . && git commit -m "knowledge check submission - $YOUR_NAME"
git push origin HEAD
```

Facilitators grade against [`rubric.md`](rubric.md).
